...
import static vista.mesajes.mensaje_dialogo_error.RET_OK;

/**
 *
 * @author ANONYMOUS
 */
public class mensaje_dialogo extends javax.swing.JDialog {
    ...
    public mensaje_dialogo(java.awt.Frame parent, boolean modal, String ptitulo, String pmensaje) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(0, 180, 23));

        lblIcono.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblIcono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vista/mesajes/cerrar.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_dialogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                mensaje_dialogo dialog = new mensaje_dialogo(new javax.swing.JFrame(), true, titulo, mensaje);
