...
public class CustomAdapterRegistro extends BaseAdapter {

    Context context;
    private List<item_lista_registro>lista;


    public CustomAdapterRegistro(Context context/*, List<item_lista_registro> lista*/) {
        this.context = context;
        this.lista = item_lista_registro.lista;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        item_lista_registro clase=lista.get(position);
...
//metodos
    ...
    public void agregar(int imagen, String dato) {
       try {
           lista.add(new item_lista_registro(imagen,dato));
       }catch (Exception e){
       }
    }

    public int getImagen(int posicion) {
        item_lista_registro  clase=lista.get(posicion);
        return clase.imagen;
    }
